...
extern cuschar * exim_dkim_signing_init(cuschar *, es_ctx *);
extern cuschar * exim_dkim_sign(es_ctx *, hashmethod, blob *, blob *);
extern cuschar * exim_dkim_verify_init(blob *, keyformat, ev_ctx *, unsigned *);
extern cuschar * exim_dkim_verify(ev_ctx *, hashmethod, blob *, blob *);
