...
extern uschar *tls_field_from_dn(uschar *, cuschar *);
...
extern BOOL    tls_import_cert(cuschar *, void **);
extern BOOL    tls_is_name_for_cert(cuschar *, void *);
# ifdef USE_OPENSSL
...
#endif
extern int     tls_write(void *, cuschar *, size_t, BOOL);
...
extern cuschar *arc_header_feed(gstring *, BOOL);
extern gstring *arc_sign(cuschar *, gstring *, uschar **);
extern void     arc_sign_init(void);
extern cuschar *acl_verify_arc(void);
extern uschar * fn_arc_domains(void);
#endif

extern void    assert_no_variables(void *, int, const char *, int);
extern int     auth_call_pam(cuschar *, uschar **);
extern int     auth_call_pwcheck(uschar *, uschar **);
extern int     auth_call_radius(cuschar *, uschar **);
extern int     auth_call_saslauthd(cuschar *, cuschar *,
	         cuschar *, cuschar *, uschar **);
extern int     auth_check_serv_cond(auth_instance *);
extern int     auth_check_some_cond(auth_instance *, uschar *, uschar *, int);
extern int     auth_client_item(void *, auth_instance *, cuschar **,
		 unsigned, int, uschar *, int);


extern int     auth_get_data(uschar **, cuschar *, int);
extern int     auth_get_no64_data(uschar **, uschar *);
extern int     auth_prompt(cuschar *);
extern int     auth_read_input(cuschar *);
...
extern uschar *b64encode(cuschar *, int);
extern uschar *b64encode_taint(cuschar *, int, const void *);
extern int     b64decode(cuschar *, uschar **);
...
extern void    cancel_cutthrough_connection(BOOL, cuschar *);
...
extern void    release_cutthrough_connection(cuschar *);
...
extern void    debug_logging_activate(cuschar *, cuschar *);
...
extern void    decode_bits(unsigned int *, size_t, int *,
	           cuschar *, bit_table *, int, uschar *, int);
...
extern void    die_tainted(cuschar *, cuschar *, int);
extern BOOL    directory_make(cuschar *, cuschar *, int, BOOL);
#ifndef DISABLE_DKIM
extern uschar *dkim_exim_query_dns_txt(cuschar *);
extern void    dkim_exim_sign_init(void);

extern BOOL    dkim_transport_write_message(transport_ctx *,
		  struct ob_dkim *, cuschar ** errstr);
#endif
extern dns_address *dns_address_from_rr(dns_answer *, dns_record *);
extern int     dns_basic_lookup(dns_answer *, cuschar *, int);
extern uschar *dns_build_reverse(cuschar *);
...
extern int     dns_lookup(dns_answer *, cuschar *, int, cuschar **);
extern void    dns_pattern_init(void);
extern int     dns_special_lookup(dns_answer *, cuschar *, int, cuschar **);
...
extern BOOL    dscp_lookup(cuschar *, int, int *, int *, int *);
...
extern int     exim_chown_failure(int, cuschar*, uid_t, gid_t);
extern cuschar * exim_errstr(int);
extern void    exim_exit(int) NORETURN;
extern void    exim_gettime(struct timeval *);
extern void    exim_nullstd(void);
extern void    exim_setugid(uid_t, gid_t, BOOL, cuschar *);
...
/* expand_string_2 does not change the uschar* parameter, so that const version
 * can safely call it with a const-cast on the parameter */
...
extern int     filter_interpret(cuschar *, int, address_item **, uschar **);
...
extern int     host_find_byname(host_item *, cuschar *, int,
				cuschar **, BOOL);
extern int     host_find_bydns(host_item *, cuschar *, int, uschar *, uschar *,
                 uschar *, const dnssec_domains *, cuschar **, BOOL *);
extern ip_address_item *host_find_interfaces(void);
extern BOOL    host_is_in_net(cuschar *, cuschar *, int);
...
extern uschar *imap_utf7_encode(uschar *, cuschar *,
				 uschar, uschar *, uschar **);

extern void    invert_address(uschar *, uschar *);
extern int     ip_addr(void *, int, cuschar *, int);
extern int     ip_bind(int, int, uschar *, int);
extern int     ip_connect(int, int, cuschar *, int, int, const blob *);
extern int     ip_connectedsocket(int, cuschar *, int, int,
                 int, host_item *, cuschar **, const blob *);
extern int     ip_get_address_family(int);
extern void    ip_keepalive(int, cuschar *, BOOL);
extern int     ip_recv(client_conn_ctx *, uschar *, int, time_t);
extern int     ip_socket(int, int);

extern int     ip_tcpsocket(cuschar *, uschar **, int, host_item *);
extern int     ip_unixsocket(cuschar *, uschar **);
extern int     ip_streamsocket(cuschar *, uschar **, int, host_item *);

extern int     ipv6_nmtoa(int *, uschar *);

extern uschar *local_part_quote(uschar *);
extern int     log_open_as_exim(cuschar * const);
...
#endif
extern int     match_address_list(cuschar *, BOOL, BOOL, cuschar **,
                 unsigned int *, int, int, cuschar **);
extern int     match_address_list_basic(cuschar *, cuschar **, int);
extern int     match_check_list(cuschar **, int, tree_node **, unsigned int **,
                 int(*)(void *, cuschar *, cuschar **, uschar **), void *, int,
                 cuschar *, cuschar **);
extern int     match_isinlist(cuschar *, cuschar **, int, tree_node **,
                 unsigned int *, int, BOOL, cuschar **);
extern int     match_check_string(cuschar *, cuschar *, int, mcs_flags,
                 cuschar **);

extern void    message_start(void);
extern void    message_tidyup(void);
extern void    md5_end(md5 *, cuschar *, int, uschar *);
extern void    md5_mid(md5 *, cuschar *);
...
extern int     mime_decode(cuschar **);
extern ssize_t mime_decode_base64(FILE *, FILE *, uschar *);
extern int     mime_regex(cuschar **, BOOL);
...
extern void    moan_tell_someone(uschar *, address_item *,
                 cuschar *, const char *, ...) PRINTF_FUNCTION(4,5);
...
extern FILE   *modefopen(cuschar *, const char *, mode_t);

extern int     open_cutthrough_connection( address_item * addr );

extern uschar *parse_extract_address(cuschar *, uschar **, int *, int *, int *,
                 BOOL);
extern int     parse_forward_list(cuschar *, int, address_item **, uschar **,
                 cuschar *, cuschar *, error_block **);
extern uschar *parse_find_address_end(cuschar *, BOOL);
extern cuschar *parse_find_at(cuschar *);
extern cuschar *parse_fix_phrase(cuschar *, int);
extern cuschar *parse_message_id(cuschar *, uschar **, uschar **);
extern cuschar *parse_quote_2047(cuschar *, int, cuschar *,
				      BOOL);
extern cuschar *parse_date_time(cuschar *str, time_t *t);
...
extern void    queue_notify_daemon(cuschar * hostname);
#endif
extern void    queue_run(uschar *, uschar *, BOOL);

extern int     random_number(int);
extern cuschar *rc_to_string(int);
extern int     rda_interpret(redirect_block *, int, cuschar *, cuschar *,
...
extern cuschar *readconf_readname(uschar *, int, cuschar *);
extern int     readconf_readtime(cuschar *, int, BOOL);
extern void    readconf_rest(void);
extern uschar *readconf_retry_error(cuschar *, cuschar *, int *, int *);
extern void    readconf_save_config(cuschar *);
...
#ifdef WITH_CONTENT_SCAN
extern int     regex(cuschar **, BOOL);
#endif
extern void    regex_at_daemon(cuschar *);
extern BOOL    regex_match(const pcre2_code *, cuschar *, int, uschar **);
extern BOOL    regex_match_and_setup(const pcre2_code *, cuschar *, int, int);
extern const pcre2_code *regex_compile(cuschar *, mcs_flags, cuschar **,
		pcre2_compile_context *);
extern const pcre2_code *regex_must_compile(cuschar *, mcs_flags, BOOL);
extern void    retry_add_item(address_item *, uschar *, int);
extern BOOL    retry_check_address(cuschar *, host_item *, uschar *, BOOL,
                 uschar **, uschar **);
extern retry_config *retry_find_config(cuschar *, cuschar *, int, int);
extern BOOL    retry_ultimate_address_timeout(uschar *, cuschar *,
                 dbdata_retry *, time_t);
extern void    retry_update(address_item **, address_item **, address_item **);
extern cuschar *rewrite_address(cuschar *, BOOL, BOOL, rewrite_rule *, int);
extern cuschar *rewrite_address_qualify(cuschar *, BOOL);
extern header_line *rewrite_header(header_line *,
               cuschar *, cuschar *,
               rewrite_rule *, int, BOOL);
extern cuschar *rewrite_one(cuschar *, int, BOOL *, BOOL, uschar *,
                 rewrite_rule *);
extern void    rewrite_test(cuschar *);
extern uschar *rfc2047_decode2(uschar *, BOOL, cuschar *, int, int *,
				     int *, cuschar **);
...
extern int     search_findtype_partial(cuschar *, int *, cuschar **, int *,
                 int *, cuschar **);
extern void   *search_open(cuschar *, int, int, uid_t *, gid_t *);
extern void    search_tidyup(void);
extern void    set_process_info(const char *, ...) PRINTF_FUNCTION(1,2);
extern void    sha1_end(hctx *, cuschar *, int, uschar *);
extern void    sha1_mid(hctx *, cuschar *);
extern void    sha1_start(hctx *);
extern int     sieve_interpret(cuschar *, int, cuschar *,
...
extern void    smtp_proxy_tls(void *, uschar *, size_t, int *, int, cuschar *) NORETURN;
...
#ifdef WITH_CONTENT_SCAN
extern int     spam(cuschar **);
extern FILE   *spool_mbox(unsigned long *, cuschar *, uschar **);
#endif
...
extern uschar *spool_sender_from_msgid(cuschar *);
...
extern gstring *string_append_listele(gstring *, uschar, cuschar *) WARN_UNUSED_RESULT;
extern gstring *string_append_listele_n(gstring *, uschar, cuschar *, unsigned) WARN_UNUSED_RESULT;
extern gstring *string_append2_listele_n(gstring *, cuschar *, cuschar *, unsigned) WARN_UNUSED_RESULT;
extern uschar *string_base62(unsigned long int);
extern gstring *string_cat (gstring *, cuschar *     ) WARN_UNUSED_RESULT;
extern gstring *string_catn(gstring *, cuschar *, int) WARN_UNUSED_RESULT;
extern int     string_compare_by_pointer(const void *, const void *);
extern uschar *string_copy_dnsdomain(uschar *);
extern uschar *string_copy_malloc(cuschar *);
extern uschar *string_dequote(cuschar **);


extern uschar *string_format_size(int, uschar *);
extern int     string_interpret_escape(cuschar **);
extern int     string_is_ip_address(cuschar *, int *);
#ifdef SUPPORT_I18N
...
extern uschar *string_domain_utf8_to_alabel(cuschar *, uschar **);
extern uschar *string_localpart_alabel_to_utf8(cuschar *, uschar **);
extern uschar *string_localpart_utf8_to_alabel(cuschar *, uschar **);
#endif

#define string_format(buf, siz, fmt, ...) \
	string_format_trc(buf, siz, cUS(__FUNCTION__), __LINE__, fmt, __VA_ARGS__)
extern BOOL    string_format_trc(uschar *, int, cuschar *, unsigned,
			const char *, ...) ALMOST_PRINTF(5,6);

#define string_vformat(g, flgs, fmt, ap) \
	string_vformat_trc(g, cUS(__FUNCTION__), __LINE__, \
			 STRING_SPRINTF_BUFFER_SIZE, flgs, fmt, ap)
extern gstring *string_vformat_trc(gstring *, cuschar *, unsigned,
			unsigned, unsigned, const char *, va_list);

#define string_open_failed(fmt, ...) \
	string_open_failed_trc(cUS(__FUNCTION__), __LINE__, fmt, __VA_ARGS__)
extern uschar *string_open_failed_trc(cuschar *, unsigned,
			const char *, ...) PRINTF_FUNCTION(3,4);

#define string_nextinlist(lp, sp, b, l) \
	string_nextinlist_trc((lp), (sp), (b), (l), cUS(__FUNCTION__), __LINE__)
extern uschar *string_nextinlist_trc(cuschar **listptr, int *separator, uschar *buffer, int buflen,
			cuschar * func, int line);

extern int     strcmpic(cuschar *, cuschar *);
extern int     strncmpic(cuschar *, cuschar *, int);
extern uschar *strstric(uschar *, uschar *, BOOL);
extern cuschar *strstric_c(cuschar *, cuschar *, BOOL);
...
extern BOOL    transport_check_waiting(cuschar *, cuschar *, int, uschar *,
                 oicf, void*);
extern uschar *transport_current_name(void);
extern void    transport_do_pass_socket(cuschar *, cuschar *,
		 cuschar *, uschar *, int);
extern void    transport_init(void);
extern BOOL    transport_pass_socket(cuschar *, cuschar *, cuschar *, uschar *, int
...
extern void    tree_add_duplicate(cuschar *, address_item *);
extern void    tree_add_nonrecipient(cuschar *);
...
extern tree_node *tree_search(tree_node *, cuschar *);
...
extern int     verify_address(address_item *, FILE *, int, int, int, int,
                 cuschar *, cuschar *, BOOL *);
extern int     verify_check_dnsbl(int, cuschar const **, cuschar **);
extern int     verify_check_header_address(cuschar **, cuschar **,
...
extern int     verify_check_this_host(cuschar **, unsigned int *,
	         cuschar*, cuschar *, cuschar **);
extern address_item *verify_checked_sender(cuschar *);
extern void    verify_get_ident(int);
extern void    verify_quota(uschar *);
extern int     verify_quota_call(cuschar *, int, int, cuschar **);
...
extern ssize_t write_to_fd_buf(int, cuschar *, size_t);
...
/******************************************************************************/
/* String functions */
static inline uschar * __Ustrcat(uschar * dst, cuschar * src, const char * func, int line)
{
#if !defined(COMPILE_UTILITY) && !defined(MACRO_PREDEF)
if (!is_tainted(dst) && is_tainted(src)) die_tainted(cUS("Ustrcat"), CUS(func), line);
#endif
return US(strcat(CS(dst), CCS(src)));
}
static inline uschar * __Ustrcpy(uschar * dst, cuschar * src, const char * func, int line)
{
#if !defined(COMPILE_UTILITY) && !defined(MACRO_PREDEF)
if (!is_tainted(dst) && is_tainted(src)) die_tainted(cUS("Ustrcpy"), CUS(func), line);
#endif
return US(strcpy(CS(dst), CCS(src)));
}
static inline uschar * __Ustrncat(uschar * dst, cuschar * src, size_t n, const char * func, int line)
{
#if !defined(COMPILE_UTILITY) && !defined(MACRO_PREDEF)
if (!is_tainted(dst) && is_tainted(src)) die_tainted(cUS("Ustrncat"), CUS(func), line);
#endif
return US(strncat(CS(dst), CCS(src), n));
}
static inline uschar * __Ustrncpy(uschar * dst, cuschar * src, size_t n, const char * func, int line)
{
#if !defined(COMPILE_UTILITY) && !defined(MACRO_PREDEF)
if (!is_tainted(dst) && is_tainted(src)) die_tainted(cUS("Ustrncpy"), CUS(func), line);
#endif
...
#define Uskip_whitespace(sp) skip_whitespace(USS(sp))
#define CUskip_whitespace(sp) cskip_whitespace(CUSS(sp))

static inline uschar cskip_whitespace(cuschar ** sp)
{ while (isspace(**sp)) (*sp)++; return **sp; }

static inline uschar skip_whitespace(uschar ** sp)
{ while (isspace(**sp)) (*sp)++; return **sp; }
...
static inline int
exim_fchown(int fd, uid_t owner, gid_t group, cuschar *name)
{
...
static inline int
exim_chown(cuschar *name, uid_t owner, gid_t group)
{
...
static inline uschar *
string_copy_taint_trc(cuschar * s, const void * proto_mem, const char * func, int line)
...
static inline uschar *
string_copy_perm(cuschar *s, BOOL force_taint)
{
...
#define string_fmt_append(g, fmt, ...) \
	string_fmt_append_f_trc(g, cUS(__FUNCTION__), __LINE__, \
...
static inline gstring *
string_fmt_append_f_trc(gstring * g, cuschar * func, unsigned line,
...
store_get_dns_answer_trc(cuschar * func, unsigned line)
{
...
static inline void
store_free_dns_answer_trc(dns_answer * dnsa, cuschar * func, unsigned line)
{
...
static inline uschar *
spool_dname(cuschar * purpose, uschar * subdir)
{
...
static inline uschar *
spool_q_sname(cuschar * purpose, cuschar * q, uschar * subdir)
{
...
static inline uschar *
spool_sname(cuschar * purpose, uschar * subdir)
{
return spool_q_sname(purpose, queue_name, subdir);
}

static inline uschar *
spool_q_fname(cuschar * purpose, cuschar * q,
	cuschar * subdir, cuschar * fname, cuschar * suffix)
{
...
static inline uschar *
spool_fname(cuschar * purpose, cuschar * subdir, cuschar * fname,
	cuschar * suffix)
{
...
static inline void
set_subdir_str(uschar * subdir_str, cuschar * name,
	int search_sequence)
{
...
static inline void
report_time_since(const struct timeval * t0, cuschar * where)
{
...
static inline pid_t
child_open_exim(int * fdptr, cuschar * purpose)
...
static inline void
smtp_debug_cmd(cuschar * buf, int mode)
{
...
#  ifndef DISABLE_CLIENT_CMD_LOG
  ...
  if (mode == SCMD_BUFFER)
    {
    client_cmd_log = string_catn(client_cmd_log, cUS("|"), 1);
...
{
#  ifndef DISABLE_CLIENT_CMD_LOG
debug_printf("cmdlog: '%s'\n", client_cmd_log ? client_cmd_log->s : cUS("(unset)"));
#  endif
}
